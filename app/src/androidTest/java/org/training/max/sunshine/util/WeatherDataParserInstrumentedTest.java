...
/**
 * Test for org.training.max.sunshine.util.WeatherDataParser, executing on Android devices
 */
@RunWith(AndroidJUnit4.class)
public class WeatherDataParserInstrumentedTest {
    ...
    public void testMountainViewThirdDay() throws JSONException {
        assertEquals(14.1, WeatherDataParser.getMaxTemperatureForDay(WEATHER_DATA_MTV_JUN_4, 2), Double.MIN_VALUE);
    }

    @Test
    public void testFremontLastDay() throws JSONException {
        assertEquals(16.75, WeatherDataParser.getMaxTemperatureForDay(WEATHER_DATA_FREMONT_JUN_4, 6), Double.MIN_VALUE);
    }
